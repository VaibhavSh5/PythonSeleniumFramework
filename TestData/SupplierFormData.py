...
class SupplierFormData:
    ...
    def getsupplierdata():
        ...
        workbook = openpyxl.load_workbook(
            os.path.dirname(os.path.dirname(__file__)) + "/ExcelDataDriven/ExcelData.xlsx")
        sheet = workbook.active

        for i in range(1, sheet.max_row + 1):
            SupplierFormData.Dict = {}
        ...
        log.info("{}{}".format("This is the complete list:", SupplierFormData.list_dict))
